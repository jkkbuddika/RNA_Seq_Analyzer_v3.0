...
Now that you know the general outline of the analysis process, go through the step-by-step guide given [here](https://github.com/jkkbuddika/RNA_Seq_Analyzer/blob/master/USERGUIDE.md) to analyze your RNA-seq data.
